...
public class MDMRelatedOperations extends CommandExecuter {
	...
	public String findMDSVersion() throws JSchException {
		String MDSVesrion = this.execute("cat /usr/sap/" + instance
				+ "/MDS*/exe/MDS_VERSION");
		return MDSVesrion;
	...
	public String findMDISVersion() throws JSchException {
		String MDISVesrion = this.execute("cat /usr/sap/" + instance
				+ "/MDIS*/exe/MDIS_VERSION");
		return MDISVesrion;
	...
	public String findMDSSVersion() throws JSchException {
		String MDSSVesrion = this.execute("cat /usr/sap/" + instance
				+ "/MDSS*/exe/MDSS_VERSION");
		return MDSSVesrion;
	...
	public String[] findMDMInstances() throws JSchException {
		String MDMInstances = new String(
				this.execute("ls /usr/sap | grep '[A-Z]'"));
		/*
		 * String MDMInstancesNumStr = new
		 * String(this.execute("ls /usr/sap | grep -c '[A-Z]'")); int
		 * MDMInstancesNum = Integer.parseInt( MDMInstancesNumStr.substring(0,
		 * 1));
		 */
