...
public class CViewConstants {
	...
	/** The Constant MDISR. */
	public static final String MDISR = "mdisr";

	/** The Constant MDSSR. */
	public static final String MDSSR = "mdssr";

	/** The Constant MEMORY_POP. */
	public static final String MEMORY_POP = "memoryPop";
	...
	/** The Constant START_IMMEDIATELY. */
	...
	/**
	 * The Enum DirectoryDirection.
	 */
	public enum DirectoryDirection {

		/** The Directory direction next. */
