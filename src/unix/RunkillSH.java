...
public class RunkillSH extends CommandExecuter {
	 ...
	 *             the j sch exception
	 */
	public void ExecuteSh(String[] paramsForSH, String SHFileName)
		...
		this.execute("nohup ./" + SHFileName + " " + allParams
				+ " > /dev/null 2>&1 &");
	 ...
	 *             the j sch exception
	 */
	public void createFileNames(String lsCommandToFindFilesNames)
			throws JSchException {

		// the command should be ls | grep _mon_ --> lsCommandToFindFilesNames =
		// ls | grep _mon_
		/*
		 * Example for the file Names are: mdis_mon_19-06-2013_13-35-10.txt
		 * mds_mon_19-06-2013_13-35-10.txt mdss_mon_19-06-2013_13-35-10.txt
